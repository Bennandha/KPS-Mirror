...
if ospath.exists('KPS_Logs.txt'):
    with open('KPS_Logs.txt', 'r+') as f:
        f.truncate(0)
...
if len(UPSTREAM_REPO) == 0:
    UPSTREAM_REPO = 'https://github.com/Tamilupdates/KPS-Mirror'

UPSTREAM_BRANCH = environ.get('UPSTREAM_BRANCH', '')
if len(UPSTREAM_BRANCH) == 0:
    UPSTREAM_BRANCH = 'railway-upadate'
...
if UPSTREAM_REPO:
    ...
    update = srun([f"git init -q \
                     && git config --global user.email dawn-in@railway.app \
